...
export const fetchWikipedia = (await fetchFunction(`https://en.m.wikipedia.org/wiki/Wikipedia:Very_short_featured_articles`))
...
// tested !!
export const newData = getAnchorTags(fetchWikipedia)

console.log(newData)


//Create folder
const createFolder = (() => !fs.existsSync(`./scraped`) && fs.mkdirSync(`./scraped`))
...
const filePath = './scraped/scraped.html'
