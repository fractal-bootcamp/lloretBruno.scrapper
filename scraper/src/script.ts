...
export const makeOutputDirectory = (scrapedData: string[] | undefined, depth: number, parentDir: string) => {
...
export async function scrapeSite(url: string, depth: number, parentDir: string, visitedUrls: Set<string>, linkVolume: number): Promise<ScrapeOptions> {
